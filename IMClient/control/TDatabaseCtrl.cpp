...
TDatabaseCtrl::TDatabaseCtrl(const QString myID, QObject *parent) :
...
*************************************************/
bool TDatabaseCtrl::searchHistoryMessage(const QString & myID, const QString & friendID,
...
*************************************************/
int TDatabaseCtrl::exportHistoryMessageOneFriend(const QString &myID ,
...
*************************************************/
int TDatabaseCtrl::exportHistoryMessageAll(const QString &myID,
...
*************************************************/
int TDatabaseCtrl::deleteHistoryMessageOneFriend(const QString myID,
                                                  const QString friendID)
{
    if (!createConnection())
    {
...
*************************************************/
int TDatabaseCtrl::deleteHistoryMessageAll(const QString myID)
{
    if (!createConnection())
    {
        return -1;
