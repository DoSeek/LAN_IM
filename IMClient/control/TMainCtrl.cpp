...
Description: 发送聊天信息
*************************************************/
void IMMainCtrl::sendTalkMessage(TTalkMessage &mes)
{
...
//// 发送群聊天信息
//void IMMainCtrl::sendFlockTalkMessage(TTalkMessage & mes)
//{
//    if (nullptr == m_tcpSocket)
//        return;
//    if (m_tcpSocket->isConnected())
...
//// 发送讨论组聊天信息
//void IMMainCtrl::sendDiscussionTalkMessage(TTalkMessage & mes)
//{
//    if (nullptr == m_tcpSocket)
//        return;
//    if (m_tcpSocket->isConnected())
...
Description: 修改自己的信息
*************************************************/
void IMMainCtrl::changeMyInformation(const TUserInformation &me)
{
    if (nullptr == m_tcpSocket)
        return;
    if (m_tcpSocket->isConnected())
...
Description: 添加好友
*************************************************/
void IMMainCtrl::addFriend(const TTalkMessage & mes)//const TTempStrings & temp)
{
    if (nullptr == m_tcpSocket)
        return;
    if (m_tcpSocket->isConnected())
...
Description: 加入群
*************************************************/
void IMMainCtrl::addFlock(const TTalkMessage & mes)//const TTempStrings & temp)
{
    if (nullptr == m_tcpSocket)
        return;
    if (m_tcpSocket->isConnected())
...
Description: 加入讨论组
*************************************************/
void IMMainCtrl::addDiscussion(const TTalkMessage & mes)
{
    if (nullptr == m_tcpSocket)
        return;
    if (m_tcpSocket->isConnected())
...
Description: 创建群
*************************************************/
void IMMainCtrl::createFlock(const TTempStrings & tmpStr)
{
    if (nullptr == m_tcpSocket)
        return;
    if (m_tcpSocket->isConnected())
...
Description: 创建讨论组
*************************************************/
void IMMainCtrl::createDiscussion(const TTempStrings & tmpStr)
{
    if (nullptr == m_tcpSocket)
        return;
    if (m_tcpSocket->isConnected())
...
Description: 修改群信息
*************************************************/
void IMMainCtrl::changeFlockInformation(const TFlockInformation & flock)
{
    if (nullptr == m_tcpSocket)
        return;
    if (m_tcpSocket->isConnected())
...
Description: 修改群成员名片
*************************************************/
void IMMainCtrl::changeFlockMemberRemark(const TTempStrings & tmpStr)
{
    if (nullptr == m_tcpSocket)
        return;
    if (m_tcpSocket->isConnected())
...
Description: 修改讨论组信息
*************************************************/
void IMMainCtrl::changeDiscussionInformation(const TDiscussionInformation & discussion)
{
    if (nullptr == m_tcpSocket)
        return;
    if (m_tcpSocket->isConnected())
...
Description: 好友请求结果
*************************************************/
void IMMainCtrl::resultOfFriendRequest(const TTalkMessage & mes)
{
    if (nullptr == m_tcpSocket)
        return;
    if (m_tcpSocket->isConnected())
...
Description: 群请求结结果
*************************************************/
void IMMainCtrl::resultOfFlockRequest(const TTalkMessage & mes)
{
    if (nullptr == m_tcpSocket)
        return;
    if (m_tcpSocket->isConnected())
...
*************************************************/
void IMMainCtrl::requestChangeMyInformation(const TUserInformation &me)
{
    if (nullptr == m_tcpSocket)
        return;
...
*************************************************/
void IMMainCtrl::requestAddFriend(const TTalkMessage & mes)
{
    if (nullptr == m_tcpSocket)
        return;
    m_blockSize = 0;
...
*************************************************/
void IMMainCtrl::requestAddFlock(const TTalkMessage & mes)
{
    if (nullptr == m_tcpSocket)
        return;
    m_blockSize = 0;
...
*************************************************/
void IMMainCtrl::requestAddDiscussion(const TTalkMessage & mes)
{
    if (nullptr == m_tcpSocket)
        return;
    m_blockSize = 0;
...
*************************************************/
void IMMainCtrl::requestCreateFlock(const TTempStrings & tmpStr)
{
    if (nullptr == m_tcpSocket)
        return;
    m_blockSize = 0;
...
Description: 发送创建群的请求
*************************************************/
void IMMainCtrl::requestCreateDiscussion(const TTempStrings & tmpStr)
{
    if (nullptr == m_tcpSocket)
        return;
    m_blockSize = 0;
...
*************************************************/
void IMMainCtrl::requestSendResultOfFriendRequest(const TTalkMessage & mes)
{
    if (nullptr == m_tcpSocket)
        return;
    m_blockSize = 0;
...
*************************************************/
void IMMainCtrl::requestSendResultOfFlockRequest(const TTalkMessage & mes)
{
    if (nullptr == m_tcpSocket)
        return;
    m_blockSize = 0;
...
*************************************************/
void IMMainCtrl::requestChangeFlockInformation(const TFlockInformation &flock)
{
    if (nullptr == m_tcpSocket)
        return;
    m_blockSize = 0;
...
*************************************************/
void IMMainCtrl::requestChangeFlockMemberRemark(const TTempStrings & tmpStr)
{
    if (nullptr == m_tcpSocket)
        return;
    m_blockSize = 0;
