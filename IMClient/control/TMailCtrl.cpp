...
Description: 请求发送邮件
*************************************************/
void IMMailCtrl::requestSendMail(const TMailInformation &mail)
{
...
Description: 请求删除邮件
*************************************************/
void IMMailCtrl::requestDeleteMail(const TMailInformation & mail)
{
...
*************************************************/
void IMMailCtrl::requestSetMailRead(const TMailInformation & mail)
{
...
void IMMailCtrl::readMessage()
{
    ...
    case SEND_MAIL_SUCCESS:
    {
        ...
        QMessageBox::information(nullptr, tr("写信"), tr("发送成功！"));
        break;
    }
    case SEND_MAIL_FAIL:
    {
        QMessageBox::information(nullptr, tr("写信"), tr("发送失败！"));
        break;
    }
    case RECEIVE_MAIL:
    {
