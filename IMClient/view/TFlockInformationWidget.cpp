...
TFlockInformationWidget::TFlockInformationWidget(TMainWidget *mainWidget,
                                                   QWidget *parent) :
    QWidget(parent)
{
...
TFlockInformationWidget::~TFlockInformationWidget()
{
}

void TFlockInformationWidget::setReadOnly(bool isReadOnly, bool isEdit)
{
...
void TFlockInformationWidget::setFlockInformation(const TFlockInformation & flock)
{
    m_flockInf = flock;
...
TFlockInformation TFlockInformationWidget::getInformation()
{
...
// protected:----------------------------------------
void TFlockInformationWidget::closeEvent(QCloseEvent *)
{
...
// public slots:-------------------------------------------
void TFlockInformationWidget::onClickCancelButton()
{
    if (!m_isReadOnly)
    {
...
void TFlockInformationWidget::onClickOKButton()
{
    if (!m_isReadOnly)
    {
        getInformation();
...
// private:------------------------------------------------
void TFlockInformationWidget::initIMLoginWidget()
{
    m_isReadOnly = true;
    m_isEdit = false;
