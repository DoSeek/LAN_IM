...
class IMFlockMemberButton : public QPushButton
{
    Q_OBJECT
public:
    IMFlockMemberButton(const TFlockMember &, TFlockChatWidget *,
                        TMainWidget *, QWidget *parent = 0);
    ~IMFlockMemberButton();

    TFlockMember &getInformation()
    {	return m_info;	}
    TFlockMember getInformation() const
    {	return m_info;	}
    void setChangedInformation(const TFlockMember & mem)
    {
...
//    TChatWidget *m_chatRoom;
    TFlockChatWidget *m_flockWidget;
