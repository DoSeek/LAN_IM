...
#include <QDebug>
#include <QMouseEvent>
TDiscussionListWidget::TDiscussionListWidget(TMainWidget *mainWidget, QWidget *parent) :
...
Description:  添加
*************************************************/
void TDiscussionListWidget::addItem(QWidget *item)
{
...
Description:  删除
*************************************************/
void TDiscussionListWidget::removeItem(QWidget *item)
{
...
Description:  创建右键菜单
*************************************************/
void TDiscussionListWidget::creatMenu()
{
...
Description:  显示右键菜单
*************************************************/
void TDiscussionListWidget::showMenu()
 {
    if (m_menu == nullptr)
    {
        //创建右键菜单
...
Description: 鼠标单击事件
*************************************************/
void TDiscussionListWidget::mousePressEvent(QMouseEvent *event)
{
