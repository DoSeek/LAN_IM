...
TLatestMessageListWidget::TLatestMessageListWidget(
...
Description:  添加
*************************************************/
void TLatestMessageListWidget::addItem(QWidget *item)
{
...
Description:  删除
*************************************************/
void TLatestMessageListWidget::removeItem(QWidget *item)
{
...
Description:  size
*************************************************/
int TLatestMessageListWidget::size()
{
...
Description:  创建右键菜单
*************************************************/
void TLatestMessageListWidget::creatMenu()
{
...
Description:  显示右键菜单
*************************************************/
void TLatestMessageListWidget::showMenu()
 {
    if (m_menu == nullptr)
    {
        //创建右键菜单
...
Description: 鼠标单击事件
*************************************************/
void TLatestMessageListWidget::mousePressEvent(QMouseEvent *event)
{
