...
class TInformationWidget : public QWidget
{
    Q_OBJECT
public:
    TInformationWidget(TMainWidget *mainWidget, QWidget *parent = 0);
     ~TInformationWidget();

    void setReadOnly(bool isReadOnly, bool isEdit);
//    void setWrite();
    void setUserInformation(const TUserInformation &user);
    TUserInformation getInformation();
protected:
    void closeEvent(QCloseEvent *);
signals:
//    void sendInformation(const TUserInformation &user);
public slots:
