...
#include "TFileSenderWidget.h"
#include "TFileReceiverWidget.h"
#include "TInputTextEdit.h"
...
TChatWidget::TChatWidget(const TChatInformation &chatInf, QWidget *parent) :
    QWidget(parent)
{
    m_chatInfor = chatInf;
...
//TChatWidget::TChatWidget(const QString &id, QWidget *parent) :
//    QWidget(parent)
//{
...
{
    if (m_fileSender != nullptr)
    {
        m_fileSender->close();
        m_fileSender->deleteLater();
        m_fileSender = nullptr;
    }
}
...
*************************************************/
void TChatWidget::appendMessageShow(const TTalkMessage &mes)
{
    QString  name;
...
*************************************************/
void TChatWidget::pendingFile(const TTalkMessage &mes)
{
...
Description:  拒绝文件
*************************************************/
void TChatWidget::refusedSendFile()
{
    if (m_fileSender != nullptr)
...
*************************************************/
void TChatWidget::pendingVideo(const TTalkMessage &mes)
{
...
Description:  显示视频窗口
*************************************************/
void TChatWidget::showVideoWidget(const TTalkMessage &mes)
{
...
*************************************************/
void TChatWidget::showCamera(const TTalkMessage &mes)
{
...
Description:  关闭视频窗口
*************************************************/
void TChatWidget::closeVideoWidget()
{
}
...
*************************************************/
void TChatWidget::setLabelStatus()
{
...
Description:  设置对方信息
*************************************************/
void TChatWidget::setChatInformation(const TChatInformation & chatInfo)
{
...
Description:  设置对方ip
*************************************************/
void TChatWidget::setFriendIP(const QString & ip)
{
...
Description:  重载关闭事件
*************************************************/
void TChatWidget::closeEvent(QCloseEvent *event)
{
    if (m_fileSender != 0)
    {
...
Description:  初始化主界面
*************************************************/
void TChatWidget::initIMChatWidget()
{
    setWidgetToolBtn();
...
Description:  连接信号与槽
*************************************************/
void TChatWidget::linkSignalWithSlot()
{
...
Description:  设置面板图标
*************************************************/
void TChatWidget::setWidgetToolBtn()
{
...
Description:  保存历史记录
*************************************************/
void TChatWidget::saveHistoryMessage()
{
...
Description:  读取历史记录
*************************************************/
void TChatWidget::readHistoryMessage()
{
    QString filePath = LOCAL_HISTORY_MESSAGE_PATH;
    filePath.append(m_chatInfor.m_myID);
    QString fileName = QString("%1_%2_friend.imres")
...
*************************************************/
void TChatWidget::onClickBtnVideo()
{
//    m_toolBtnVideo->setEnabled(false);
...
Description:  语音
*************************************************/
void TChatWidget::onClickBtnVoice()
{
}
...
Description:  发送文件
*************************************************/
void TChatWidget::onClickBtnFile()
{
    if (m_fileSender->isVisible())
    {
        return;
    }
    if (ELS_OFFLINE == m_chatInfor.m_friendStatus)
    {
        QMessageBox::critical(nullptr, tr("发送文件"), tr("好友不在线，暂时无法发送"));
        return;
    }
...
Description:  空间
*************************************************/
void TChatWidget::onClickBtnSpace()
{
}
...
Description:  字体样式
*************************************************/
void TChatWidget::setInputTextFont(const QFont &font)
{
...
Description:  字体大小
*************************************************/
void TChatWidget::setInputTextSize(const QString &size)
{
...
Description:  加粗
*************************************************/
void TChatWidget::onClickBtnBold(bool checked)
{
    if(checked)
...
Description:  斜体
*************************************************/
void TChatWidget::onClickBtnItalic(bool checked)
{
...
Description:  下划线
*************************************************/
void TChatWidget::onClickBtnUnderline(bool checked)
{
...
Description:  颜色
*************************************************/
void TChatWidget::onClickBtnColor()
{
...
Description:  清空
*************************************************/
void TChatWidget::onClickBtnClear()
{
    saveHistoryMessage();
...
Description:  聊天历史记录
*************************************************/
void TChatWidget::onClickBtnHistory(bool checked)
{
...
Description:  部件状态
*************************************************/
void TChatWidget::currentFormatChanged(const QTextCharFormat &format)
...
*************************************************/
void TChatWidget::onClickBtnClose()
{
    this->close();
}
...
*************************************************/
void TChatWidget::onClickBtnSend()
{
