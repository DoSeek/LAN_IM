...
TFlockListWidget::TFlockListWidget(TMainWidget *mainWidget, QWidget *parent) :
...
Description:  添加
*************************************************/
void TFlockListWidget::addItem(QWidget *item)
{
...
Description:  删除
*************************************************/
void TFlockListWidget::removeItem(QWidget *item)
{
...
Description:  创建右键菜单
*************************************************/
void TFlockListWidget::creatMenu()
{
...
Description:  显示右键菜单
*************************************************/
void TFlockListWidget::showMenu()
 {
    if (m_menu == nullptr)
    {
        //创建右键菜单
...
Description: 鼠标单击事件
*************************************************/
void TFlockListWidget::mousePressEvent(QMouseEvent *event)
{
