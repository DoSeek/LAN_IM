...
#include "TDiscussionMemberButton.h"
#include "TDiscussionMemberListWidget.h"
#include "TMainWidget.h"
#include "TClientFileCtrl.h"

TDiscussionChatWidget::TDiscussionChatWidget(const TDiscussionInformation & discussion,
...
TDiscussionChatWidget::~TDiscussionChatWidget()
{
...
*************************************************/
void TDiscussionChatWidget::appendMessageShow(const TTalkMessage &mes)
{
...
*************************************************/
void TDiscussionChatWidget::setLabelStatus()
{
...
Description:  设置讨论组信息
*************************************************/
void TDiscussionChatWidget::setChatInformation(const TDiscussionInformation & discussion)
{
...
Description:  添加成员按钮
*************************************************/
bool TDiscussionChatWidget::addDiscussionMemberButton(const TDiscussionMember & memInfo)
{
...
Description:  删除成员按钮
*************************************************/
bool TDiscussionChatWidget::removeDiscussionMemberButton(const QString & memberID)
{
...
Description:  设置成员列表
*************************************************/
void TDiscussionChatWidget::setDiscussionMemberList(
        const QVector<TDiscussionMember> & memberList)
{
...
Description:  重载关闭事件
*************************************************/
void TDiscussionChatWidget::closeEvent(QCloseEvent *event)
{
...
Description:  字体样式
*************************************************/
void TDiscussionChatWidget::setInputTextFont(const QFont &font)
{
...
Description:  字体大小
*************************************************/
void TDiscussionChatWidget::setInputTextSize(const QString &size)
{
...
Description:  加粗
*************************************************/
void TDiscussionChatWidget::onClickBtnBold(bool checked)
{
    if(checked)
...
Description:  斜体
*************************************************/
void TDiscussionChatWidget::onClickBtnItalic(bool checked)
{
...
Description:  下划线
*************************************************/
void TDiscussionChatWidget::onClickBtnUnderline(bool checked)
{
...
Description:  颜色
*************************************************/
void TDiscussionChatWidget::onClickBtnColor()
{
...
Description:  清空
*************************************************/
void TDiscussionChatWidget::onClickBtnClear()
{
    saveHistoryMessage();
...
Description:  聊天历史记录
*************************************************/
void TDiscussionChatWidget::onClickBtnHistory(bool checked)
{
    if (checked)
    {
...
Description:  部件状态
*************************************************/
void TDiscussionChatWidget::currentFormatChanged(const QTextCharFormat &format)
...
*************************************************/
void TDiscussionChatWidget::onClickBtnClose()
{
    this->close();
}
...
*************************************************/
void TDiscussionChatWidget::onClickBtnSend()
{
...
Description:  初始化主界面
*************************************************/
void TDiscussionChatWidget::initIMDiscussionChatWidget()
{
    setWidgetToolBtn();
...
Description:  连接信号与槽
*************************************************/
void TDiscussionChatWidget::linkSignalWithSlot()
{
...
Description:  设置面板图标
*************************************************/
void TDiscussionChatWidget::setWidgetToolBtn()
{
...
Description:  保存历史记录
*************************************************/
void TDiscussionChatWidget::saveHistoryMessage()
{
...
Description:  读取历史记录
*************************************************/
void TDiscussionChatWidget::readHistoryMessage()
{
    QString filePath = LOCAL_HISTORY_MESSAGE_PATH;
    filePath.append(m_mainWidget->getLocalMyInformation().m_userID);
    QString fileName = QString("%1_%2_discussion.imres")
