...
IMMailInformationWidget::IMMailInformationWidget(TMailWidget * mailWidget,
                                                 QWidget *parent) :
     m_mailWidget(mailWidget), QWidget(parent)
{
    if (nullptr == m_mailWidget)
        return;
...
Description:  设置邮件信息
*************************************************/
void IMMailInformationWidget::setMailInformation(const TMailInformation & mail)
{
    m_mail = mail;
