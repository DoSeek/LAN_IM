...
TFriendListWidget::TFriendListWidget(TMainWidget *mainWidget, QWidget *parent) :
...
Description:  添加
*************************************************/
void TFriendListWidget::addItem(QWidget *item)
{
...
Description: 创建右键菜单
*************************************************/
void TFriendListWidget:: creatMenu()
{
...
Description:  显示右键菜单
*************************************************/
void TFriendListWidget::showMenu()
 {
    if (m_menu == nullptr)
    {
        //创建右键菜单
...
Description: 鼠标点击事件
*************************************************/
void TFriendListWidget:: mousePressEvent(QMouseEvent *event)
{
