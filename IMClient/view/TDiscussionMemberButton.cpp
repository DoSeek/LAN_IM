...
IMDiscussionMemberButton::IMDiscussionMemberButton(const TDiscussionMember &discussionMember,
                                                   TDiscussionChatWidget *discussionWidget,
...
//{
//    bool isOk = false;
//    QString remark = QInputDialog::getText(nullptr, "修改名片",
//                                           "请输入新的名片",
//                                           QLineEdit::Normal,
//                                           m_info.m_remark,
//                                           &isOk);
...
void IMDiscussionMemberButton::onClickRemoveMember()
{
    ...
    returnBtn = QMessageBox::question(nullptr, tr("移除讨论组成员"),
