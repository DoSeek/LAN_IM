...
IMMessageWidget::IMMessageWidget(TMainWidget * mainWidget, QWidget *parent) :
...
Description: 设置显示的消息
*************************************************/
void IMMessageWidget::setMessageShow(const QVector<TTalkMessage> & mesVec)
{
