...
#include "TClickLabel.h"
#include "TFlockMemberButton.h"
#include "TFlockMemberListWidget.h"
#include "TMainWidget.h"
#include "TClientFileCtrl.h"

TFlockChatWidget::TFlockChatWidget(const TFlockInformation & flock,
...
TFlockChatWidget::~TFlockChatWidget()
{
...
*************************************************/
void TFlockChatWidget::appendMessageShow(const TTalkMessage &mes)

{
    //qDebug() << "flock receive mes:" << mes.m_senderID << m_flockInfor.m_flockID << mes.m_text;
    // using TTalkMessage.m_senderID to find user's name
...
*************************************************/
void TFlockChatWidget::setLabelStatus()
{
...
Description:  设置群信息
*************************************************/
void TFlockChatWidget::setChatInformation(const TFlockInformation & flock)
{
...
Description:  设置群成员名片
*************************************************/
void TFlockChatWidget::setFlockMemberRemark(const TTempStrings & tmpStr)
{
...
Description:  添加群成员按钮
*************************************************/
bool TFlockChatWidget::addFlockMemberButton(const TFlockMember & memInfo)
{
...
Description:  删除成员按钮
*************************************************/
bool TFlockChatWidget::removeFlockMemberButton(const QString & memberID)
{
...
Description:  设置群成员列表
*************************************************/
void TFlockChatWidget::setFlockMemberList(const QVector<TFlockMember> & memberList)
{
...
Description:  重载关闭事件
*************************************************/
void TFlockChatWidget::closeEvent(QCloseEvent *event)
{
...
Description:  字体样式
*************************************************/
void TFlockChatWidget::setInputTextFont(const QFont &font)
{
...
Description:  字体大小
*************************************************/
void TFlockChatWidget::setInputTextSize(const QString &size)
{
...
Description:  加粗
*************************************************/
void TFlockChatWidget::onClickBtnBold(bool checked)
{
    if(checked)
...
Description:  斜体
*************************************************/
void TFlockChatWidget::onClickBtnItalic(bool checked)
{
...
Description:  下划线
*************************************************/
void TFlockChatWidget::onClickBtnUnderline(bool checked)
{
...
Description:  颜色
*************************************************/
void TFlockChatWidget::onClickBtnColor()
{
...
Description:  清空
*************************************************/
void TFlockChatWidget::onClickBtnClear()
{
    saveHistoryMessage();
...
Description:  聊天历史记录
*************************************************/
void TFlockChatWidget::onClickBtnHistory(bool checked)
{
    if (checked)
    {
...
Description:  部件状态
*************************************************/
void TFlockChatWidget::currentFormatChanged(const QTextCharFormat &format)
...
*************************************************/
void TFlockChatWidget::onClickBtnClose()
{
    this->close();
}
...
*************************************************/
void TFlockChatWidget::onClickBtnSend()
{
...
Description:  初始化主界面
*************************************************/
void TFlockChatWidget::initIMFlockChatWidget()
{
    setWidgetToolBtn();
...
Description:  连接信号与槽
*************************************************/
void TFlockChatWidget::linkSignalWithSlot()
{
...
Description:  设置面板图标
*************************************************/
void TFlockChatWidget::setWidgetToolBtn()
{
...
Description:  保存历史记录
*************************************************/
void TFlockChatWidget::saveHistoryMessage()
{
...
Description:  读取历史记录
*************************************************/
void TFlockChatWidget::readHistoryMessage()
{
    QString filePath = LOCAL_HISTORY_MESSAGE_PATH;
    filePath.append(m_mainWidget->getLocalMyInformation().m_userID);
    QString fileName = QString("%1_%2_flock.imres")
