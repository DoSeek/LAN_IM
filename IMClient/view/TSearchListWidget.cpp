...
TSearchListWidget::TSearchListWidget(QWidget *parent) :
...
Description:  添加
*************************************************/
void TSearchListWidget::addItem(QWidget *item)
{
...
Description:  删除
*************************************************/
void TSearchListWidget::removeItem(QWidget *item)
{
...
Description:  删除所有
*************************************************/
void TSearchListWidget::clearAll()
{
