...
TDiscussionInformationWidget::TDiscussionInformationWidget(TMainWidget *mainWidget,
                                                             QWidget *parent) :
    QWidget(parent)
{
...
TDiscussionInformationWidget::~TDiscussionInformationWidget()
{
}


void TDiscussionInformationWidget::setReadOnly(bool isReadOnly, bool isEdit)
{
...
void TDiscussionInformationWidget::setDiscussionInformation(
...
TDiscussionInformation TDiscussionInformationWidget::getInformation()
{
...
// protected:--------------------------------------------------------
void TDiscussionInformationWidget::closeEvent(QCloseEvent *)
{
...
// public slots:-----------------------------------------------------
void TDiscussionInformationWidget::onClickCancelButton()
{
    if (!m_isReadOnly)
    {
...
void TDiscussionInformationWidget::onClickOKButton()
{
    if (!m_isReadOnly)
    {
        getInformation();
...
// private:-------------------------------------------------------
void TDiscussionInformationWidget::initIMLoginWidget()
{
    m_isReadOnly = true;
    m_isEdit = false;
