...
struct TSaveTmpInformation
{
    int m_requestKind;
    int m_replyKind;
    TClientSocketCtrl *m_clientSocket;
    ...
    TUserInformation m_userInf;
    TLoginInformation m_loginInf;
    TFriendInformation m_friendInf;
    TTalkMessage m_message;
    int m_status;
    TTempStrings m_tempStr;
    QVector<TTalkMessage> m_messageVec;
    ...
    QVector<TTalkMessage> m_historyMessageVec;
};
